功能表
167KB PHP 程式碼片段於 2023 年 2 月 20 日 建立。 這是私人檔案。
                        ...
                        <div class="card-body"> -->
                            <div class="search-btn-group text-nowrap">
                                ...
                                <div class="d-flex" id="s_ChangeTypeImage">
                                    ...
                                    <div class="form-group mt-4">
                                        <select class="form-control" data-status="floor" id="hu_height">
                ...
                [
                    {
                        ...
                        "label": [
                            ...
                            @foreach($chuang_tags as $tag)
                                {"name":"{{$tag->name}}", "id":parseInt("{{$tag->id}}"), "left":parseInt("{{$tag->left}}"), "top":parseInt("{{$tag->top}}")},
                            @endforeach
                        ],
